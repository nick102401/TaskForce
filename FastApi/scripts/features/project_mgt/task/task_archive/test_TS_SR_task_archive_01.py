...
/*
@author:王东
@file:test_TS_SR_task_archive_01.py
@time:2021/08/31
*/
...
# 自定义参数
taskName1 = 'TS_SR_task_archive_01_1' + get_random_str(2)
taskName2 = 'TS_SR_task_archive_01_2' + get_random_str(2)
taskName3 = 'TS_SR_task_archive_01_3' + get_random_str(2)
