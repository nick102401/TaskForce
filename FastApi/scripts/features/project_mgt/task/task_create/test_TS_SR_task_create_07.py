...
# 生成随机字符串
taskName1 = 'TS_SR_task_create_07_1' + get_random_str(3)
taskName2 = 'TS_SR_task_create_07_2' + get_random_str(3)
...
@allure.feature('我的项目')
@allure.story('任务')
@allure.title('单个任务的点数不能大于每周饱和工作点数')
def test_step_02():
    log.info('-----测试用例执行-----')
    '''
    测试步骤
    1.单个任务的点数大于每周饱和工作点数,有预期结果1
